...
revision: "0"
updated: "Sep-21"
generated_from: "row-8-ISM-1667.response.md"
...
> [!NOTE]
> Enable both ISM-1667 (child process) and ISM-1668 (executable content) rules for defence-in-depth: the executable content rule blocks payload creation; the child process rule blocks post-creation execution.
