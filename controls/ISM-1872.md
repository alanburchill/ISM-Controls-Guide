...
- Dependencies
  - A **Microsoft Entra ID** tenant to enable and enforce phishing-resistant authentication via **authentication strengths** and **Conditional Access** policies, including phishing-resistant options such as **Windows Hello for Business**, **Passkeys (FIDO2)**, and **Certificate-Based Authentication**[^3]
